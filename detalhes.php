        ...
        <section>
            <div class="container">
                <fieldset class="conteudo">
                    <h1 style="padding: 5px;"> Icon of the Seas</h1>
                    <h3 class="definicao">Ícone de férias em família</h3>
                    <img src="../ASSETS/N01.webp" alt="" class="img" />
                    <p>
                    ...
                    <ul>
                        <li><b>Ano de Construção:</b> xxxx</li>
                        <li><b>Cabine com acesso para cadeira de rodas:</b> (sim/não)</li>
                        <li><b>Largura:</b> xx m</li>
                        <li><b>Comprimento:</b> xxx m</li>
                        <li><b>Toneladas:</b> xxx.xxx tn</li>
                        <li><b>Velocidade de Navegação:</b> xx nós</li>
                        <li><b>Número total de passageiros:</b> xxxx</li>
                        <li><b>Número de Tripulantes:</b> xxxx</li>
                        <li><b>Nº Decks:</b> xx</li>
                        <li><b>Nº Cabines:</b> número de cabines: xxxx</li>
                        <li><b>Idiomas a bordo:</b> xxxxx, xxxxxx. xxxxxxx, xxx</li>
                    </ul>
                </fieldset>
            </div>
        </section>
